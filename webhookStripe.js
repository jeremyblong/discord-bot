        ...
        try {
            ...
            switch (event.type) {
                ...
                case 'customer.source.created':
                    ...
                    console.log("customer.source.created", customerSourceCreated);
                    break;
                case 'customer.updated': 
                    ...
                    break;
                case 'payment_method.attached':
                    const payoutMethodAttached = event.data.object; 

                    console.log("payment_method.attached", payoutMethodAttached);
                    break;
